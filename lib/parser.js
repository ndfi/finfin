...
/** Find the first category (and its parent type) whose keyword appears in the text. */
 ...
 */
export function parseHebrewMessage(rawText) {
  ...
  const { category, categoryType } = extractCategory(text);
